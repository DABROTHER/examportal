...
//   const [value, onChange] = useState(new Date());
  ...
  const [selectedValue, setSelectedValue] = React.useState("B.tech / BE");
    ...
    if (doc.exists) {
        ...
        if(password){
            firebase
                ...
                .then(res=>{
                    console.log("res",res)
                    const url =`To login, please click here: http://deftsoft-amit-task.surge.sh/ and enter your email and password. Your credential are emai:${getemail}  , password: ${password}`;
  ...
  return (
	...
	<div className="container">
		...
		<div className="login-content">
			<form style={{width:"1000px", marginLeft:"-9%"}} onSubmit={formRegistartion}>
				{/* <img src={avtar}/> */}
      ...
      <FormGroup aria-label="position" row>
        <p style={{marginTop:"2%", marginLeft:"0%",}}>Hobbies:</p>
        <FormControlLabel
          value="Drawing"
