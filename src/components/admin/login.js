...
export default function MiniDrawer(props) {
  ...
  const LoginUser = (e) =>{
   ...
   if(email==="admin@gmail.com" && password==="@dmin123"){
       localStorage.setItem('deftToken',uuid)
      props.history.push({
        pathname:`/admin/dashboard?token=${uuid}`,
          data:uuid,
  ...
  return (
	...
	<div className="container">
		...
		<div className="login-content">
			<form style={{width:"300%", marginLeft:"-2%"}} onSubmit={LoginUser}>
				<img src={avtar}/>
